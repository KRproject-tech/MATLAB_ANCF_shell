...
generate_stiff_matrices_explicit;
...
% qe_global_struct.Qe_global = (Qe_global_n + Qe_global_np1)/2 + (Qk_global_n + Qk_global_np1)/2;
qe_global_struct.Qe_global = Qe_global_np1 + Qk_global_np1;
%%[1-4] 減衰力       : Q_d
qd_global_struct.Qd_global = Qd_global_n;
